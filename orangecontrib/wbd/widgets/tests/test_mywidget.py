...
class TestWorldBankDataWidget(unittest.TestCase):
    ...
    @mock.patch("orangecontrib.wbd.widgets.simple_filter_widget.SimpleFilterWidget.ok_button_clicked")
    @mock.patch("wbpy.IndicatorAPI")
    def test_click_events(self, indicator_api, ok_event, fetch_event):
    ...
    @mock.patch("orangecontrib.wbd.widgets.simple_filter_widget.SimpleFilterWidget.ok_button_clicked")
    @mock.patch("wbpy.IndicatorAPI")
    def test_return_pressed_event(self, indicator_api, ok_event, fetch_event):
        widget = mywidget.WorldBankDataWidget()
        # import ipdb; ipdb.set_trace()
